...
public class ExplicitlyLoadedActivity extends Activity {
	...
	private void enterClicked() {
		...
		Intent sendTextBack = new Intent(ExplicitlyLoadedActivity.this,ActivityLoaderActivity.class);
		sendTextBack.putExtra(Intent.EXTRA_TEXT,enteredText);
		
		// Set Activity's result with result code RESULT_OK
		setResult(Activity.RESULT_OK,sendTextBack);
