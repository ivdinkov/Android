...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i(TAG, "Starting AddToDoActivity OnCreate");
		...
		datePickerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.i(TAG, "datePickerButton pressed");
			}
		});
		...
		timePickerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.i(TAG, "timePickerButton pressed");
			}
		});
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Log.i(TAG, "AddToDoActivity Cancel and finish");
				finish();
			}
		});
		
		// MyTODOSet up OnClickListener for the Reset Button
		final Button resetButton = (Button) findViewById(R.id.resetButton);
		resetButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Log.i(TAG, "AddToDoActivity Reset Values to their default");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finish();
				Log.i(TAG, "AddToDoActivity return data to intent");
